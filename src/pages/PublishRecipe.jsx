...
const { user, publishRecipe } = useUser()
  ...
  async function handleSubmit(e) {
    ...
    const result = await publishRecipe({
      ...
      ingredients,
      instructions: steps,
      categorias: selectedCategories, // Enviando corretamente a lista de IDs selecionados
    })
    ...
    <div className="publish-page">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input className="form-title" name="title" value={form.title} onChange={handleChange} placeholder="Ex: Bolo de Chocolate" required />
        </div>
        <div>
        ...
        <div className="categories-checkbox-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px', margin: '10px 0' }}>
          {categoriesFromDb.length === 0 ? (
            ...
            categoriesFromDb.map(c => {
              ...
              return (
                <label key={idCat} className="category-checkbox">
                  <input 
                    type="checkbox" 
